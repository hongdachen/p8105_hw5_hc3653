...
![](p8105_hw5_hc3653_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->

From the graph, we can see that the overall trend is increasing
gradually. When the number of people is extremely small, the probability
of same birthday is almost 0. When the number of people approaches 50,
the probability approaches 1. The mid-point of probability happens when
the number of people is exactly 23.
...
![](p8105_hw5_hc3653_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->

The effect size and power is positively related, larger the mu, more
likely to reject the null hypothesis, so larger the power.
...
![](p8105_hw5_hc3653_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](p8105_hw5_hc3653_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->

In samples for which the null hypothesis was rejected, the average
estimate of mu is greater than true value of mu, particularly when mu is
small, because of the selection bias.
...
![](p8105_hw5_hc3653_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
